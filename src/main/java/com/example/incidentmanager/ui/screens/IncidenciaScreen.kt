...
import com.example.incidentmanager.ui.composables.IncidenciaCard
...
@Composable
fun IncidenciaScreen (navController: NavHostController, viewModel: IncidenciaViewModel) {

    var expanded by remember { mutableStateOf(false) }
    var query: String by rememberSaveable { mutableStateOf("") }
    val filteredIncidencies by viewModel.filteredIncidencies.collectAsState() // Observador de la lista sencera d'usuaris

    LaunchedEffect(Unit) {
        viewModel.fetchAllIncidencies()
    }
    ...
    Column (
        ...
        ) { items(filteredIncidencies) { incidencia -> IncidenciaCard(incidencia) } }
    }
}