...
import com.example.incidentmanager.ui.composables.ActiuCard
...
@Composable
fun ActiuScreen (navController: NavHostController, viewModel: ActiuViewModel) {

    var expanded by remember { mutableStateOf(false) }
    var query: String by rememberSaveable { mutableStateOf("") }
    val filteredActius by viewModel.filteredActius.collectAsState() // Observador de la lista sencera d'usuaris

    LaunchedEffect(Unit) {
        viewModel.fetchAllActius()
    }
    ...
    Column (
        ...
        ) { items(filteredActius) { actiu -> ActiuCard(actiu) } }
    }
}