...
/**
 * Classe que representa la finestra de diàleg per eliminar un usuari de la base de dades.
 * Permet introduir l'email de l'usuari que es vol eliminar i interactua amb el servei d'usuaris per completar l'acció.
...
public class FinestraEliminarUsuari extends JDialog {
    ...
    /**
     * Constructor de la finestra per eliminar un usuari.
     ...
     * Obté el correu electrònic de l'usuari des del camp de text, comprova si l'usuari vol continuar amb l'eliminació
     * i crida el servei per eliminar l'usuari.
     * Mostra missatges de notificació segons si l'usuari ha estat trobat i eliminat amb èxit o no.
     */
