...
/**
 * Classe que gestiona la finestra de login per l'aplicació.
 * Aquesta finestra permet a l'usuari introduir les seves credencials d'usuari,
 * l'adreça del servidor i el port, i autenticar-se per accedir a l'aplicació.
 * @author Enrique
 */
public class FinestraLogin extends JFrame {
     ...
     * Configura la finestra, els components visuals i els esdeveniments associats.
     * Estableix la mida de la finestra, el títol, i afegeix els components de l'UI com
     * camps de text i botons per a l'autenticació.
     */
     ...
     * Valida les dades d'entrada, establix una connexió amb el servidor
     * i gestiona l'autenticació de l'usuari.
     * Si la connexió SSL fallida o les dades d'entrada són incorrectes,
     * es mostrarà un missatge d'error.
     * @throws SocketTimeoutException Si el temps de connexió és esgotat.
     */
     ...
     * @param ip La cadena d'IP a comprovar.
     * @return true si l'IP és vàlida, false en cas contrari.
     */
