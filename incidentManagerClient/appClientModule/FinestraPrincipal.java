...
/**
 * Classe principal de la finestra de la interfície d'usuari per gestionar incidències,
 * usuaris, actius i altres funcionalitats en el sistema de gestió d'incidències.
 * 
 * @author Enrique
 */
public class FinestraPrincipal extends JFrame {
     ...
     * 
     * @param servidor El servidor associat amb la finestra.
     */
    ...
    /**
     * Constructor privat per inicialitzar la finestra principal amb les dades del usuari.
     * 
     * @param usuari El nom de l'usuari.
     * @param rol El rol de l'usuari (Gestor, Administrador, etc.).
     * @param idSessio L'identificador de la sessió.
     */
